...
<html lang="<?php echo $lang; ?>">
  ...
  <body spellcheck="off">
    ...
    <!-- BETA: Можно обойтись и без этого
    <div class="view-edit">
    ...
    <section content>
      ...
      <article loader unselectable>
        ...
        <script src="js/get_row.js"></script>

        <!--<div class="row" type="block"> ids="0,1,2"
          <div post image style="background-image: linear-gradient(to top, rgba(0,0,0,0.1), rgba(0,0,0,0.1)), url('css/img/upload/moderation/f244b1bbb12fd84f7ae77784994bb905/fff5c6cf4ca1543a72b64bf5dff0d8ef.png')">
            <div class="wrapper"><h3>Тестовый тест. Тестовый тест. Тестовый тест. Тестовый тест. Тестовый тест</h3></div>
          </div>
        </div>-->
